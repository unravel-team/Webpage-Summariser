 ...
 */
export declare class LiteRtLmNotLoadedError extends Error {
    constructor();
}
/**
 ...
 */
export declare function getGlobalLiteRtLm(): LiteRtLm;
/**
 * Check if the global LiteRT-LM instance is defined.
 *
 * Only exposed internally.
 */
export declare function hasGlobalLiteRtLm(): boolean;
/**
 * Set the global LiteRT-LM instance.
 *
 * Only exposed internally.
 */
export declare function setGlobalLiteRtLm(LiteRtLm: LiteRtLm | undefined): void;
/**
 ...
 * undefined.
 */
export declare function getGlobalLiteRtLmPromise(): Promise<LiteRtLm> | undefined;
/**
 * Check if the global LiteRT-LM instance promise is defined.
 *
 * Only exposed internally.
 */
export declare function hasGlobalLiteRtLmPromise(): boolean;
/**
 * Set the global LiteRT-LM instance promise.
 *
 * Only exposed internally.
 */
export declare function setGlobalLiteRtLmPromise(promise: Promise<LiteRtLm> | undefined): void;
//# sourceMappingURL=global_litertlm.d.ts.map