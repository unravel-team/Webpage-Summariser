...
import { SamplerType } from './wasm_binding_types.js';
 ...
 */
export function sessionConfigToWasmSessionConfig(sessionConfig, wasm = getGlobalLiteRtLm().liteRtLmWasm) {
 ...
 */
export function wasmSessionConfigToSessionConfig(wasmSessionConfig) {
    const samplerParams = wasmSessionConfig.getMutableSamplerParams();
    return {
        ...
        stopTokenIds: consumeEmscriptenVectorToArray(wasmSessionConfig.getStopTokenIds())
